PhenoCams = [
    ...
    'field_type': 'BOOLEAN',
    'field_default_vale': False},
    {'field_name': 'is_L1', 'field_type': 'BOOLEAN', 'field_default_vale': False},
